...
return [
    ...
    /*
     ...
     | class 'MichelMelo\Stemming\TokenFilterEnRu' from token filters.
     |
    ...
    */
    'analyzer' => [
        ...
        'filters' => [
            'MichelMelo\Stemming\TokenFilterEnRu',
        ],

        'stopwords' => MichelMelo\LaravelSearch\Analyzer\Stopwords\Files::get(),
    ],
];
