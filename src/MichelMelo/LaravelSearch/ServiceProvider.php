...
use Config;
use MichelMelo\LaravelSearch\Analyzer\Config as AnalyzerConfig;
use MichelMelo\LaravelSearch\Analyzer\Stopwords\FilterFactory;
use MichelMelo\LaravelSearch\Index\Connection;
use MichelMelo\LaravelSearch\Model\Config as ModelsConfig;
...
class ServiceProvider extends \Illuminate\Support\ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('MichelMelo\LaravelSearch\Search', function ($app) {
            return $app['search'];
        });
        ...
        $this->app->bind('MichelMelo\LaravelSearch\Analyzer\Config', function () {
        ...
        $this->app->singleton('laravel-lucene-search.connection', function ($app) {
            return new Connection(
                ...
                $app->make('MichelMelo\LaravelSearch\Analyzer\Config')
            );
        });
        ...
        $this->app->singleton('laravel-lucene-search.models.config', function ($app) {
            return new ModelsConfig(
                ...
                $app->make('MichelMelo\LaravelSearch\Model\Factory')
            );
        });
    ...
    {
        return ['search', 'command.search.rebuild', 'command.search.clear'];
    }
}
