...
use MichelMelo\LaravelSearch\Highlighting\Html;
use MichelMelo\LaravelSearch\Index\Connection;
use MichelMelo\LaravelSearch\Model\Config;
...
class Search
{
    ...
    /**
     * @return \MichelMelo\LaravelSearch\Model\Config
     */
    ...
    public function highlight($html)
    {
        ...
        $highlighter = App::make('MichelMelo\LaravelSearch\Highlighting\Html');
