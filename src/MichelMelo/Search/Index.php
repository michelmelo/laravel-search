...
abstract class Index
{
     ...
     * @param string $driver
     *
     * @return \MichelMelo\Search\Index
     */
     ...
     *
     * @return \MichelMelo\Search\Query
     */
     ...
     * @return bool
     */
    abstract public function createIndex(array $fields = []);
     ...
     * @return array
     */
    abstract public function runQuery($query, array $options = []);
     ...
     * @return bool
     */
    abstract public function insert($id, array $fields, array $parameters = []);
